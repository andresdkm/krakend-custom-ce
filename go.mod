...
require (
	...
	github.com/krakend/krakend-audit v0.6.0
	github.com/krakend/krakend-botdetector/v2 v2.3.0
	github.com/krakend/krakend-ce/v2 v2.12.0
	...
	github.com/luraproject/lura/v2 v2.13.0
